...
export const TokenSelect = forwardRef<HTMLButtonElement, TokenSelectProps>(function TokenSelect({ selected, onSelect, excludeToken, className }, ref) {
    ...
    const handleOpenChange = (newOpen: boolean) => {
      ...
      if (newOpen && isConnected) {
        // Refetch balances when opening dialog
        refetch();
      }
    };
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        'hover:bg-primary/10 text-left active:scale-[0.98]',
                    ...
                    >
                      ...
                      <div className={`w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-sm font-bold flex-shrink-0 ${token.logoURI ? 'hidden' : ''}`}>
                        {token.symbol[0]}
                      </div>
